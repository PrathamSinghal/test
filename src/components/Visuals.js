...
import exampleSound from "../assets/HowItWorks.mp3";
...
function Visuals() {
  ...
  const [audioExample, setAudioExample] = useState(new Audio(exampleSound));
  const [audioPlayExample, setAudioPlayExample] = useState(false);
  ...
  useEffect(() => {
    setAudioPlayExample(false);
    audioExample.pause();

    switch (myState.algorithm) {
      case "bubble":
        setAudioExample(new Audio(bubbleSortSound));
        break;
      case "insertion":
        setAudioExample(new Audio(exampleSound));
        break;
      case "merge":
        setAudioExample(new Audio(mergeSortSound));
        break;
      case "quick":
        setAudioExample(new Audio(quickSortSound));
        break;
      case "selection":
        setAudioExample(new Audio(selectionSortSound));
        break;
      default:
        break;
    }
        ...
        <button
          ...
          onClick={() => {
            ...
            if(audioPlayExample) {
              ...
              audioExample.play();
              setAudioPlayExample(true);
            }
          }}
        >
          {" "}
          {audioPlay ? "Example Audio Pause" : "Example Audio Play"}{" "}
        </button>
      </div>
